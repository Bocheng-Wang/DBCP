 ...
 *   https://datatables.net/download/#bs/dt-1.10.22/af-2.3.5/b-1.6.4/rg-1.1.2/sc-2.0.3/sp-1.2.0
 *
 * Included libraries:
 *   DataTables 1.10.22, AutoFill 2.3.5, Buttons 1.6.4, RowGroup 1.1.2, Scroller 2.0.3, SearchPanes 1.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.22/af-2.3.5/b-1.6.4/rg-1.1.2/sc-2.0.3/sp-1.2.0",
